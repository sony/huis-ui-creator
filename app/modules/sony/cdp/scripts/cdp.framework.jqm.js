...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        // AMD
        define(["cdp.core", "cdp.lazyload", "i18n"], function () {
...
(function (CDP) {
    ...
    (function (Framework) {
        ...
        function initialize(options) {
            ...
            if (_initialized) {
                console.warn("cdp.framework.jqm is already initialized, ignored.");
                return df.resolve();
            }
            // CDP 環境の初期化
            // 現状は、console オブジェクトの保証と jQuery の WinRT 対応。
            CDP.initialize().done(function () {
        ...
        function getConfig() {
            var defConfig = {
                ...
                i18nDataPath: function () {
                    return "";
                },
                applyPatch: true,
                anchorVclick: true,
            };
            return $.extend({}, defConfig, CDP.global.Config);
        }
        ///////////////////////////////////////////////////////////////////////
        // closure methods
        // resize handler
    ...
    (function (Framework) {
        ...
        var Page = (function () {
            ...
            Page.prototype.pageBeforeHide = function (event, data) {
                ...
                if (null != this._intent && this._intent._update) {
