        ...
        var GroupProfile = (function () {
            ...
            GroupProfile.prototype.collapse = function (delay) {
                ...
                if (!this.hasChildren()) {
                    ...
                    if (0 < lines.length) {
                        delay = (null != delay) ? delay : this._owner.getListViewOptions().animationDuration;
                ...
                if (this._$owner) {
                    ...
                    var proc = function () {
                        if (_this._$scroller && _this._$scroller.height() !== _this._iscroll.scrollerHeight) {
                            ...
                            _this._refreshTimerId = setTimeout(proc, _this._listviewOptions.scrollMapRefreshInterval);
                        }
                        else {
