...
module Garage {
    export module View {
        ...
        export class ImagePropertyArea extends PropertyArea {
            ...
            //private labelPreviewWindow_: LabelPreviewWindow; TODO
            ...
            constructor(iamge: Model.ImageItem, commandManager: CommandManager) {
                ...
                //this.labelPreviewWindow_ = new LabelPreviewWindow(label); TODO
            ...
            render(): Backbone.View<Model.Item> {
                ...
                //this.$el.find(this.labelPreviewWindow_.getDomId()).append(this.labelPreviewWindow_.render().$el); TODO
