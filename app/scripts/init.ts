...
module Garage {
    var setup = (callback: Function): void => {
        ...
        NON_SUPPORT_DEVICE_TYPE_IN_EDIT = [DEVICE_TYPE_CUSTOM, DEVICE_TYPE_FULL_CUSTOM];
        NON_SUPPORT_FACE_CATEGORY = [DEVICE_TYPE_CUSTOM, DEVICE_TYPE_FULL_CUSTOM, DEVICE_TYPE_SPECIAL];
        NON_SUPPORT_DEVICE_TYPE_IN_MACRO = [DEVICE_TYPE_CUSTOM, DEVICE_TYPE_FULL_CUSTOM, DEVICE_TYPE_SPECIAL];
