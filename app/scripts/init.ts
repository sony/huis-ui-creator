...
module Garage {
	var setup = (callback: Function): void => {
		...
		RATIO_TEXT_SIZE_HUIS_GARAGE_BUTTON = 0.7;
		RATIO_TEXT_SIZE_HUIS_GARAGE_LABEL = 0.689;
		MIN_TEXT_SIZE = 12;
		GAIN_TEXT_BUTTON_SIZE_OFFSET_FUNC = 0.00115;
		GAIN_TEXT_LABEL_SIZE_OFFSET_FUNC = 0.00035;
